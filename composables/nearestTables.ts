export function formatHTML(index: number, data: object) {
  ...
  string += `
  <a href=${gmap_link} target="_blank" rel="noopener noreferrer" class="flex items-center underline underline-offset-2 text-md hover:text-[var(--dark-text-secondary-color-hover)]">Open map for directions
